        ...
        >
            <div className="bg-slate-200 w-full max-w-full sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl lg:min-w-[600px] 2xl:max-w-4xl mx-auto mt-10 rounded-xl p-5">
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='p-2 cursor-pointer hover:bg-slate-300 rounded-xl' onClick={() => setOpenModal(false)}>
                        <CloseRoundedIcon />
                    </div>
                </div>
                ...
                {emptyCart == false && (
                    <>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <Button variant="contained" color="success" onClick={() => navigate('/compra')}>Confirmar Compra</Button>
                        </div>
                    </>
                )}
            </div>
